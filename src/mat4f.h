...
// Given a width bound, height bound, z-near, and z-far compute a orthographic projection matrix.
void mat4f_make_orthographic(mat4f_t* m, float width, float height, float near, float far);
